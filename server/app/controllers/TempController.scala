...
class TempController @Inject() (cc: MessagesControllerComponents) extends MessagesAbstractController(cc) {
  ...
  // this is a GET/ parameters displayed in the URL.... do not use GET for sensitive data  / use to retrieve data
  ...
  // use PLAY forms to automate  (POST)
